...
[![GitHub Release](https://img.shields.io/github/v/release/christian45410/hass-govee_light_ble?sort=semver&style=for-the-badge&color=green)](https://github.com/christian45410/hass-govee_light_ble/releases/)
[![GitHub Release Date](https://img.shields.io/github/release-date/christian45410/hass-govee_light_ble?style=for-the-badge&color=green)](https://github.com/christian45410/hass-govee_light_ble/releases/)
![GitHub Downloads (all assets, latest release)](https://img.shields.io/github/downloads/christian45410/hass-govee_light_ble/latest/total?style=for-the-badge&label=Downloads%20latest%20Release)
...
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/christian45410/hass-govee_light_ble?style=for-the-badge)
...
6. Add following URL to the repository `https://github.com/christian45410/hass-govee_light_ble`.
...
To install this integration manually you have to download [_govee_light_ble.zip_](https://github.com/christian45410/hass-govee_light_ble/releases/latest/) and extract its contents to `config/custom_components/govee_light_ble` directory:

```bash
mkdir -p custom_components/govee_light_ble
cd custom_components/govee_light_ble
wget https://github.com/christian45410/hass-govee_light_ble/releases/latest/download/govee_light_ble.zip
